    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 block">
                ...
                <?php
                    $query_more = "SELECT * FROM komunikaty WHERE `numery linii` like '%".$row['numery linii']."%' and `id` Not Like '".$id."'";
                    if ($result = @$connect->query($query_more)) {
                        $statements = $result->num_rows;
                        if ($statements > 0) {
                            while ($row1 = $result->fetch_array()) {
                                echo "<a href='admin.php?page=statements&id=".$row1['id']."'>".$row1['temat']."</a><br/>";
                            }
                        }
                    }
                ?></br>
